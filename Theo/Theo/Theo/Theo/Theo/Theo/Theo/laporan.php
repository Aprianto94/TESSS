        ...
        <table border="1" cellpadding="10" cellspacing="0" class="table table-bordered border-secondary bg-white text-center">
            ...
            <?php while($data = $query->fetch()): ?>
                <tr>
                    ...
                    <td><?= $data['status'] ?></td>
                    <td>
                         <a href="detail_laporan.php?id=<?= $data['id_pengaduan'] ?>"class="btn btn-info">Detail</a>
                        <a href="edit2.php?nik=<?= $data['nik'] ?>"class="btn btn-secondary">Update</a>
                        <a href="proses_hapus2.php?id_pengaduan=<?= $data['id_pengaduan'] ?>"class="btn btn-danger">Hapus</a>
                    </td> 
