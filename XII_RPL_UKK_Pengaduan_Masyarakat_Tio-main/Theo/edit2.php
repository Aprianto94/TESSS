...
<br>
                <a href="laporan.php"class="btn btn-danger"><i class="bi bi-arrow-left-circle"></i></a>
                <button type="submit" class="btn btn-success"><i class="bi bi-patch-check"></i></button>
            </form>
        </div>
    </div>
</body>
